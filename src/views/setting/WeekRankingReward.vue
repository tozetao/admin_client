  ...
  <div>
    <div class="inline-filter">
      ...
      <div class="item">
        ...
        <el-button type="primary" @click="onSet">设置周排行榜</el-button>
...
import { fetchData, update, create, changeType, deleteWeekRanking, PointRanking, rankingTypeOptions, translateType } from '@/api/week_ranking_reward'

const Create = 1
const Edit = 2

export default {
  name: 'WeekRankingReward',
  data() {
    return {
      innerQuery: {
        type: PointRanking
